...
export default class Jsongenerator extends React.Component {
  ...
  generateJson(event) {
    ...
    if (this.props.data) {
      ...
      let generatedFile = new File([generated], "pattern.json", {type: "JSON"});
      ...
      <div className="container">
        <form id="jsonGen">
          <div className="inputgroup" > 
            ...
            <input name="patternName" id="patternName" onChange={this.updateData} ></input>
          </div>
          <div className="inputgroup"> 
            <label htmlFor="patternTags" >tags</label>
            <input name="patterntTags" id="patternTags"  onChange={this.updateData}></input>
          </div>
          <div className="inputgroup">
            <label>styles</label>
            <textarea id="patternStyles" name="patternStyles"  onChange={this.updateData} />
          </div>
          <div className="inputgroup">
            <label>Html</label>
            <textarea id="patternHtml" name="patternHtml"  onChange={this.updateData} />
          </div>
          <div className="inputgroup">
            <label>Java Script</label>
            <textarea id="patternScript" name="patternHtml"  onChange={this.updateData} />
          </div>
          <div className="inputgroup">
